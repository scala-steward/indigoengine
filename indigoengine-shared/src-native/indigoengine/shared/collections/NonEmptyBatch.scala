...
final case class NonEmptyBatch[A](head: A, tail: Batch[A]) derives CanEqual:
  ...
  override def toString: String =
    s"NonEmptyBatch[$head][${tail.toVector.mkString(", ")}]"
  ...
  def mkString(separator: String): String =
    head.toString + separator + tail.toVector.mkString(separator)
  ...
  def mkString(prefix: String, separator: String, suffix: String): String =
    prefix + head.toString + separator + tail.toVector.mkString(separator) + suffix
